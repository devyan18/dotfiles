...
() {
  ...
  typeset -g POWERLEVEL10K_PROMPT_CHAR_OVERWRITE_STATE=true
  ...
  typeset -g POWERLEVEL10K_PROMPT_CHAR_LEFT_{LEFT,RIGHT}_WHITESPACE=
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      local meta='%244F' clean='%76F' modified='%178F' untracked='%39F' conflicted='%196F'
    else
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%F{red}%B%n@%m%b%f'
  ...
  typeset -g POWERLEVEL9K_ANACONDA_SHOW_SYSTEM=true
  ...
  typeset -g POWERLEVEL9K_DOTNET_VERSION_FULL=false
...
# Configuración del root_indicator
typeset -g POWERLEVEL9K_ROOT_INDICATOR_ICON='⚡︎'
typeset -g POWERLEVEL9K_ROOT_INDICATOR_FOREGROUND=196
typeset -g POWERLEVEL9K_ROOT_INDICATOR_VISUAL_IDENTIFIER_EXPANSION='${POWERLEVEL9K_ROOT_INDICATOR_ICON}'
